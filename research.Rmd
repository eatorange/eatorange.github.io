...
### [Food Security Dynamics in the U.S., 2001-2017](files/Food_Security_Dynamics_AJAE_published.pdf){target="_blank"} (JMP)
...
### [Estimating Multidimensional Development Resilience](files/Estimating_Multidimensional_Development_Resilience-202507.pdf){target="_blank"}

With [Kibrom A. Abay](https://www.ifpri.org/profile/kibrom-abay){target="_blank"}, [Christopher B. Barrett](http://barrett.dyson.cornell.edu/){target="_blank"} and [John H. Hoddinott](https://www.human.cornell.edu/people/jfh246){target="_blank"} - *forthcoming* at *Journal of Development Economics*
